            ...
            <div className="rounded-md shadow-xl max-w-sm sm:max-w-md w-full bg-colorGray">
                <div className="rounded-md shadow min-h-60 p-6">
                    <div className="flex items-center justify-between mb-4">
                        <button onClick={onClose} className="text-white bg-transparent hover:bg-gray-200 hover:text-zinc-200 rounded-md text-sm h-8 w-8 ms-auto inline-flex justify-center items-center">
                            <IoMdClose size={30} />
                        </button>
                    </div>
